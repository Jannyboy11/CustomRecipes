...
public class Bukkit2NMSIngredient /* extends RecipeItemStack */ implements Predicate<ItemStack> {
	...
	public Bukkit2NMSIngredient(CraftingIngredient bukkIngredient) {
		this.bukkitIngredient = bukkIngredient;
	}

	@Override
	public boolean test(ItemStack nmsStack) {
		return bukkitIngredient.test(CraftItemStack.asCraftMirror(nmsStack));
	}
